...
export const Route = createRootRoute({
  ...
  head: () => ({
    meta: [
      ...
      { title: "TrueTips — Sports Prediction & Analytics Console" },
      { name: "description", content: "TrueTips M-Pesa payment analytics and prediction management portal" },
      { name: "author", content: "TrueTips" },
      { property: "og:title", content: "TrueTips" },
      { property: "og:description", content: "TrueTips M-Pesa payment analytics and prediction management portal" },
