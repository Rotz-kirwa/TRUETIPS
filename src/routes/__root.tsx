...
export const Route = createRootRoute({
  ...
  head: () => ({
    meta: [
      ...
      { title: "Sure-10 Predict — Sports Prediction & Analytics Console" },
      { name: "description", content: "Sure-10 Predict M-Pesa payment analytics and prediction management portal" },
      { name: "author", content: "Sure-10 Predict" },
      { property: "og:title", content: "Sure-10 Predict" },
      { property: "og:description", content: "Sure-10 Predict M-Pesa payment analytics and prediction management portal" },
