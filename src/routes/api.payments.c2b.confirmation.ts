    ...
    handlers: {
      POST: async ({ request }) => {
        ...
        try {
          ...
          console.error("[api/payments/c2b/confirmation] Audit failed, attempting direct JSON parse:", auditErr);
          try {
        ...
        try {
          ...
          console.error("[api/payments/c2b/confirmation] Handler error:", error);
